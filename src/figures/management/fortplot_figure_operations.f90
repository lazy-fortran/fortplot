module fortplot_figure_operations
    ...
    use fortplot_figure_core_config, only: grid_figure, set_xlabel_figure, &
                                           set_ylabel_figure, &
                                           set_title_figure, set_xscale_figure, &
                                           set_yscale_figure, &
...
contains
    ...
    subroutine figure_add_contour_operation(plots, state, x_grid, y_grid, z_grid, &
                                            levels, label)
    ...
    subroutine figure_add_fill_between_operation(plots, state, x, upper, lower, mask, &
        ...
        call figure_add_fill_between(plots, state, x, upper, lower, mask, &
                                     color_string, alpha)
        call set_axis_for_latest_plot(state, plots)
    end subroutine figure_add_fill_between_operation

    subroutine figure_add_pie_operation(plots, state, values, labels, startangle, &
        ...
        call figure_add_pie(plots, state, values, labels, startangle, color_strings, &
                            explode, autopct)
        call set_axis_for_latest_plot(state, plots)
    ...
    subroutine figure_boxplot_operation(state, plots, plot_count, data, position, &
	    ...
	    subroutine figure_scatter_operation(state, plots, plot_count, x, y, s, c, marker, &
	                                        markersize, color, colormap, alpha, edgecolor, &
