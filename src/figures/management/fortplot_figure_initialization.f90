module fortplot_figure_initialization
    !! Figure initialization module
    !!
    !! Single Responsibility: Initialize figures, manage state lifecycle,
    !! and provide lazy storage allocation.
    !! Configuration procedures (backend setup, dimensions, labels, scales, limits)
    !! are in fortplot_figure_configuration.
    ...
    type :: figure_state_t
        ...
        !! Text-backend charset: 'ascii' (default), 'unicode', 'auto', or
