...
contains
    ...
    subroutine set_xticks(self, positions, labels)
        ...
        if (present(labels)) then
            ...
            do i = 1, n
                ...
                self%state%custom_xtick_labels(i) = adjustl(self%state%custom_xtick_labels(i))
            end do
        end if
    ...
    subroutine set_yticks(self, positions, labels)
        ...
        if (present(labels)) then
            ...
            do i = 1, n
                ...
                self%state%custom_ytick_labels(i) = adjustl(self%state%custom_ytick_labels(i))
            end do
        end if
    ...
    subroutine set_xtick_labels(self, labels)
    ...
    subroutine set_ytick_labels(self, labels)
