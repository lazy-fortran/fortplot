...
contains
    ...
    subroutine viridis_colormap(t, color)
        ...
        real(wp), dimension(5) :: r_points = [0.267_wp, 0.229_wp, 0.173_wp, &
                                              0.329_wp, 0.993_wp]
        real(wp), dimension(5) :: g_points = [0.005_wp, 0.322_wp, 0.531_wp, &
                                              0.758_wp, 0.906_wp]
        real(wp), dimension(5) :: b_points = [0.329_wp, 0.545_wp, 0.737_wp, &
                                              0.525_wp, 0.144_wp]
    ...
    subroutine plasma_colormap(t, color)
        ...
        real(wp), dimension(5) :: r_points = [0.050_wp, 0.504_wp, 0.783_wp, &
                                              0.947_wp, 0.940_wp]
        real(wp), dimension(5) :: g_points = [0.030_wp, 0.063_wp, 0.216_wp, &
                                              0.542_wp, 0.975_wp]
        real(wp), dimension(5) :: b_points = [0.528_wp, 0.614_wp, 0.631_wp, &
                                              0.457_wp, 0.131_wp]
    ...
    subroutine inferno_colormap(t, color)
        ...
        real(wp), dimension(5) :: r_points = [0.001_wp, 0.258_wp, 0.642_wp, &
                                              0.936_wp, 0.988_wp]
        real(wp), dimension(5) :: g_points = [0.000_wp, 0.021_wp, 0.179_wp, &
                                              0.493_wp, 0.645_wp]
        real(wp), dimension(5) :: b_points = [0.014_wp, 0.146_wp, 0.225_wp, &
                                              0.151_wp, 0.041_wp]
    ...
    subroutine crest_colormap(t, color)
        ...
        real(wp), dimension(5) :: r_points = [0.855_wp, 0.627_wp, 0.373_wp, &
                                              0.188_wp, 0.063_wp]
        real(wp), dimension(5) :: g_points = [0.929_wp, 0.851_wp, 0.671_wp, &
                                              0.447_wp, 0.282_wp]
        real(wp), dimension(5) :: b_points = [0.941_wp, 0.918_wp, 0.847_wp, &
                                              0.698_wp, 0.502_wp]
