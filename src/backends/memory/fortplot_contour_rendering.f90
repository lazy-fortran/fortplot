...
contains
    ...
    subroutine process_contour_cell(backend, plot_data, i, j, level, xscale, yscale, &
                                    symlog_threshold)
        ...
        ! Draw contour lines
        if (num_lines > 0) then
            call draw_contour_lines(backend, line_points, num_lines, xscale, yscale, &
                                    symlog_threshold)
        end if
    end subroutine process_contour_cell

    subroutine draw_contour_lines(backend, line_points, num_lines, xscale, yscale, &
                                  symlog_threshold)
