...
contains
    ...
    subroutine test_mismatched_dimensions()
        ...
        call fig%savefig('/tmp/test_mismatch_dims.txt')
        ...
        call fig%savefig('/tmp/test_correct_dims.txt')
    ...
    subroutine test_single_point_data()
        ...
        call fig%savefig('/tmp/test_single_point.txt')
        ...
        block
            ...
            call fig%savefig('/tmp/test_single_cell.txt')
        end block
    ...
    subroutine test_extreme_values()
        ...
        call fig%initialize(40, 20)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('/tmp/test_large_values.txt')
        ...
        call fig%initialize(40, 20)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('/tmp/test_small_values.txt')
        ...
        call fig%initialize(40, 20)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('/tmp/test_mixed_extreme.txt')
    ...
    subroutine test_nan_and_inf_handling()
        ...
        call fig%initialize(30, 15)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('/tmp/test_with_nan.txt')
        ...
        call fig%initialize(30, 15)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('/tmp/test_with_inf.txt')
        ...
        call fig%initialize(30, 15)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('/tmp/test_mixed_special.txt')
    ...
    subroutine test_zero_size_figure()
        ...
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('/tmp/test_tiny_figure.txt')
        
        ! Test with very wide aspect ratio
        call fig%initialize(100, 10)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('/tmp/test_wide_figure.txt')
        
        ! Test with very tall aspect ratio
        call fig%initialize(20, 50)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('/tmp/test_tall_figure.txt')
    ...
    subroutine test_dimension_mismatch_pcolormesh()
        ...
        call fig%savefig('/tmp/test_pcolormesh_correct.txt')
        ...
        block
            ...
            call fig%savefig('/tmp/test_pcolormesh_alt.txt')
        end block
