...
contains
    ...
    subroutine test_mismatched_dimensions()
        ...
        call fig%savefig('test_mismatch_dims.txt')
        ...
        call fig%savefig('test_correct_dims.txt')
    ...
    subroutine test_single_point_data()
        ...
        call fig%savefig('test_single_point.txt')
        ...
        block
            ...
            call fig%savefig('test_single_cell.txt')
        end block
    ...
    subroutine test_extreme_values()
        ...
        call fig%initialize(40, 20)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('test_large_values.txt')
        ...
        call fig%initialize(40, 20)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('test_small_values.txt')
        ...
        call fig%initialize(40, 20)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('test_mixed_extreme.txt')
    ...
    subroutine test_nan_and_inf_handling()
        ...
        call fig%initialize(30, 15)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('test_with_nan.txt')
        ...
        call fig%initialize(30, 15)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('test_with_inf.txt')
        ...
        call fig%initialize(30, 15)
        call fig%add_contour_filled(x, y, z)
        call fig%savefig('test_mixed_special.txt')
