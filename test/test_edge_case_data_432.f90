program test_edge_case_data_432
    ...
    call fig%savefig("build/build/test/output/test_zero_arrays.png")
    ...
    call fig%set_xlabel("X axis")
    call fig%set_ylabel("Y axis")  
    call fig%savefig("build/build/test/output/test_zero_arrays.txt")
    ...
    call fig%set_xlabel("X axis")
    call fig%set_ylabel("Y axis")
    call fig%savefig("build/build/test/output/test_single_point.png")
    ...
    call fig%set_xlabel("X axis")
    call fig%set_ylabel("Y axis")
    call fig%savefig("build/build/test/output/test_single_point.txt")
    ...
    call fig%set_xlabel("X axis")
    call fig%set_ylabel("Y axis")
    call fig%savefig("build/build/test/output/test_normal_data.png")
    ...
    call fig%set_xlabel("X axis") 
    call fig%set_ylabel("Y axis")
    call fig%savefig("build/build/test/output/test_normal_data.txt")
    ...
    call fig%set_xlabel("X axis")
    call fig%set_ylabel("Y axis")
    call fig%savefig("build/build/test/output/test_mixed_edge_cases.png")
