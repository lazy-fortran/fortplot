program test_numeric_limits_433
    ...
    call fig%savefig("build/test/output/test_limits_linear.png")
    ...
    call fig%savefig("build/test/output/test_limits_log.png")
    ...
    call fig%set_ylabel("Y axis")
    call fig%set_xscale("log")
    call fig%savefig("build/test/output/test_limits_ascii.txt")
    ...
    call fig%set_ylabel("Y axis")
    call fig%set_xscale("log")
    call fig%savefig("build/test/output/test_controlled_extreme.png")
