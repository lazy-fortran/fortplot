program test_scientific_ranges
    ...
    call fig%savefig("build/test/output/test_scientific_range.png")
    ...
    call fig%set_ylabel("Y axis")
    call fig%set_xscale("log")
    call fig%savefig("build/test/output/test_scientific_range.txt")
    ...
    call fig%set_ylabel("Y axis")
    call fig%set_xscale("log")
    call fig%savefig("build/test/output/test_engineering_range.png")
    ...
    call fig%set_ylabel("Y axis")
    call fig%set_xscale("log")
    call fig%savefig("build/test/output/test_edge_clamp_range.png")
