...
contains
    ...
    subroutine test_legend_box_sizing()
        ...
        call fig%savefig('test/test_legend_box_sizing.png')
    ...
    subroutine test_legend_text_positioning()
        ...
        call fig%legend()
        call fig%savefig('test/test_legend_text_positioning.png')
    ...
    subroutine test_legend_placement_margins()
        ...
        call fig%savefig('test/test_legend_margins_ul.png')
        
        call fig%legend(location="upper right")
        call fig%savefig('test/test_legend_margins_ur.png')
        
        call fig%legend(location="lower left")
        call fig%savefig('test/test_legend_margins_ll.png')
        
        call fig%legend(location="lower right")
        call fig%savefig('test/test_legend_margins_lr.png')
    ...
    subroutine test_legend_visual_quality()
        ...
        call fig%legend()
        call fig%savefig('test/test_legend_visual_quality.png')
