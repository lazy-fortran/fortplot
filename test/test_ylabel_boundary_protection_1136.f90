program test_ylabel_boundary_protection_1136
    ...
    print *, '  Generated: ', trim(output_dir)//'test_ylabel_extreme_length_1136.png'
    ...
    print *, '  Generated: ', trim(output_dir)//'test_ylabel_wide_ticks_1136.png'
    ...
    print *, '  Generated: ', trim(output_dir)//'test_ylabel_small_canvas_1136.png'
    ...
    test_count = test_count + 1
    ! Inputs: 200px label width and 80px tick labels
