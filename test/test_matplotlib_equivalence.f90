...
contains
    ...
    subroutine test_same_parameters()
        ...
        call fig%savefig('test/test_matplotlib_equivalent.png')
    ...
    subroutine test_same_behavior()
        ...
        call fig%savefig('test/test_matplotlib_higher_density.png')
        
        ! Test 2: Lower density  
        call fig%initialize(800, 600)
        call fig%streamplot(x, y, u, v, density=0.7_real64)
        call fig%set_title('Lower density test')
        call fig%savefig('test/test_matplotlib_lower_density.png')
