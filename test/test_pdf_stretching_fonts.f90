program test_pdf_stretching_fonts
    !! PDF stretching and font handling tests
    ...
    print *, "=== PDF STRETCHING AND FONTS TESTS ==="
...
contains
    ...
    subroutine print_test_summary()
        write(*, '(A)') '============================================'
        write(*, '(A)') 'PDF Stretching and Fonts Test Summary'
        write(*, '(A, I0, A, I0)') 'Tests run: ', test_count, ' | Passed: ', pass_count
        write(*, '(A)') 'Stretching and font handling tests COMPLETED!'
        write(*, '(A)') '============================================'
    end subroutine print_test_summary

end program test_pdf_stretching_fonts