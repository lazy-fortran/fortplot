...
contains
    ...
    subroutine test_legend_api()
        ...
        call fig%savefig('test/test_legend_basic.png')
    ...
    subroutine test_legend_positioning()
        ...
        call fig%savefig('test/test_legend_upper_left.png')
        
        call fig%legend(location="lower right")  
        call fig%savefig('test/test_legend_lower_right.png')
    ...
    subroutine test_legend_rendering()
        ...
        call fig%savefig('test/test_legend_render.png')
        call fig%savefig('test/test_legend_render.pdf')
        call fig%savefig('test/test_legend_render.txt')
