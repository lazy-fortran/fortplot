...
program test_parameter_validation_edge_cases
    ...
    call savefig("build/test/output/test_large_dimensions.png")
    ...
    call plot(tiny_data, tiny_data)
    call savefig("build/test/output/test_tiny_dimensions.png")
    ...
    call plot(tiny_data, tiny_data)
    call savefig("build/test/output/test_extreme_aspect.png")
    ...
    call savefig("build/test/output/" // repeat("a", 300) // ".png")
    ...
    call savefig("build/test/output/test_font_boundaries.png")
    ...
    call plot(tiny_data, tiny_data)
    call savefig("build/test/output/test_basic_edge.png")
    ...
    call savefig("build/test/output/test_edge_data.png")
    ...
    call plot(tiny_data, tiny_data)
    call savefig("build/test/output/test_validation_width.png")
    ...
    call plot(tiny_data, tiny_data)
    call savefig("build/test/output/test_validation_height.png")
    ...
    call savefig("build/test/output/test_validation_font.png")
