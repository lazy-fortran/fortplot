...
program test_parameter_validation_edge_cases
    ...
    call savefig(test_get_temp_path("test_large_dimensions.png"))
    ...
    call plot(tiny_data, tiny_data)
    call savefig(test_get_temp_path("test_tiny_dimensions.png"))
    ...
    call plot(tiny_data, tiny_data)
    call savefig(test_get_temp_path("test_extreme_aspect.png"))
    ...
    call savefig(test_get_temp_path(repeat("a", 300) // ".png"))
    ...
    call savefig(test_get_temp_path("test_font_boundaries.png"))
    ...
    call plot(tiny_data, tiny_data)
    call savefig(test_get_temp_path("test_basic_edge.png"))
    ...
    call savefig(test_get_temp_path("test_edge_data.png"))
    ...
    call plot(tiny_data, tiny_data)
    call savefig(test_get_temp_path("test_validation_width.png"))
    ...
    call plot(tiny_data, tiny_data)
    call savefig(test_get_temp_path("test_validation_height.png"))
    ...
    call savefig(test_get_temp_path("test_validation_font.png"))
