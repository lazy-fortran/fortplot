...
contains
    ...
    subroutine test_pcolormesh_ascii_rendering()
        ...
        call fig%savefig('test_pcolormesh_checkerboard.txt')
        ...
        call fig%initialize(60, 30)
        call fig%add_pcolormesh(x, y, z)
        call fig%savefig('test_pcolormesh_gradient.txt')
    ...
    subroutine test_pcolormesh_coordinate_systems()
        ...
        block
            real(wp) :: x_irreg(6), y_irreg(5), z_irreg(5, 4)
            integer :: i, j
            
            ! Non-uniform x spacing
            x_irreg = [0.0_wp, 0.1_wp, 0.3_wp, 0.7_wp, 1.5_wp, 3.0_wp]
            ...
            call fig%savefig('test_pcolormesh_irregular.txt')
        end block
    ...
    subroutine test_pcolormesh_value_ranges()
        ...
        call fig%add_pcolormesh(x, y, z)
        call fig%savefig('test_pcolormesh_small_values.txt')
        ...
        call fig%initialize(50, 25)
        call fig%add_pcolormesh(x, y, z)
        call fig%savefig('test_pcolormesh_large_values.txt')
        ...
        call fig%initialize(50, 25)
        call fig%add_pcolormesh(x, y, z)
        call fig%savefig('test_pcolormesh_uniform.txt')
        ...
        call fig%initialize(50, 25)
        call fig%add_pcolormesh(x, y, z)
        call fig%savefig('test_pcolormesh_with_nan.txt')
    ...
    subroutine test_pcolormesh_grid_sizes()
        ...
        block
            ...
            call fig%savefig('test_pcolormesh_minimal.txt')
        end block
        
        ! Test rectangular grid (non-square)
        block
            real(wp) :: x_rect(21), y_rect(6), z_rect(20, 5)
            integer :: i, j
            ...
            do i = 1, 20
                do j = 1, 5
                    z_rect(i, j) = sin(x_rect(i) * 3.0_wp) * cos(y_rect(j) * 2.0_wp)
                end do
            end do
            
            call fig%initialize(80, 30)
            call fig%add_pcolormesh(x_rect, y_rect, z_rect)
            call fig%savefig('test_pcolormesh_rectangular.txt')
        end block
    ...
    subroutine test_pcolormesh_edge_alignment()
        ...
        call fig%savefig('test_pcolormesh_edges.txt')
    ...
    subroutine test_pcolormesh_with_labels()
        ...
        do i = 1, 15
            do j = 1, 10
                z(i, j) = sin(x(i) * 2.0_wp) * sin(y(j) * 2.0_wp)
            end do
        end do
        ...
        call fig%savefig('test_pcolormesh_labeled.txt')
    ...
    subroutine test_pcolormesh_colormap_variations()
        ...
        call fig%initialize(60, 30)
        call fig%add_pcolormesh(x, y, z)
        call fig%savefig('test_pcolormesh_colormap.txt')
