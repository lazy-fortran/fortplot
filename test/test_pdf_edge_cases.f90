...
contains
    ...
    subroutine test_extreme_tight_range()
        ...
        call fig%savefig("/tmp/test_extreme_tight.pdf")
    ...
    subroutine test_many_tick_candidates()
        ...
        call fig%savefig("/tmp/test_many_candidates.pdf")
    ...
    subroutine test_zero_crossing_precision()
        ...
        call fig%savefig("/tmp/test_zero_precision.pdf")
    ...
    subroutine test_negative_small_values()
        ...
        call fig%savefig("/tmp/test_negative_small.pdf")
    ...
    subroutine test_mixed_scale_scenarios()
        ...
        call fig%savefig("/tmp/test_mixed_scales.pdf")
