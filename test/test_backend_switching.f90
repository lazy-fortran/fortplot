program test_backend_switching
    ...
    call fig%savefig("build/test/output/test_png_to_pdf.pdf")  ! Should auto-switch to PDF
    
    validation = validate_pdf_format('build/test/output/test_png_to_pdf.pdf')
    ...
    call fig%savefig("build/test/output/test_pdf_to_png.png")  ! Should auto-switch to PNG
    
    validation = validate_png_format('build/test/output/test_pdf_to_png.png')
    if (validation%passed) then
    ...
    call fig%savefig("build/test/output/test_ascii_to_pdf.pdf")  ! Should auto-switch to PDF
    
    validation = validate_pdf_format('build/test/output/test_ascii_to_pdf.pdf')
    if (validation%passed) then
    ...
    ! Save as PDF
    call fig%savefig("build/test/output/test_multi.pdf")
    validation = validate_pdf_format('build/test/output/test_multi.pdf')
    ...
    call fig%savefig("build/test/output/test_multi.png")
    validation = validate_png_format('build/test/output/test_multi.png')
    if (.not. validation%passed) then
