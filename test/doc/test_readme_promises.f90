program test_readme_promises
    ...
    ! All outputs directed to build/test/output/ to maintain clean repository root
    use fortplot
    implicit none
    ...
    call savefig("build/test/output/test_readme_basic.png")
    ...
    call savefig("build/test/output/test_3d_plot.png")
    ...
    call legend()
    call savefig("build/test/output/test_trig_functions.pdf")
    ...
    call legend()
    call savefig("build/test/output/test_unicode_demo.png")
    ...
    call legend()
    call savefig("build/test/output/test_scientific_plot.png")
