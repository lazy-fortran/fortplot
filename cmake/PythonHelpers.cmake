...
#   FILES_TO_WRAP - The source files to wrap. Needs not to include all library
#                   sources.
function(add_f2py_wrapper F2PY_MODULE_NAME LIBRARY_TO_WRAP FILES_TO_WRAP)
    list(TRANSFORM FILES_TO_WRAP PREPEND "${CMAKE_SOURCE_DIR}/")

    message(STATUS "Python module name: ${F2PY_MODULE_NAME}")
    ...
    add_custom_command(OUTPUT ${F2PY_WRAPPERS}
        ...
        COMMENT "Processing sources with f2py"
    )
...
#                   sources.
#
function(add_f90wrap_wrapper PYTHON_MODULE LIBRARY_TO_WRAP FILES_TO_WRAP)
    list(TRANSFORM FILES_TO_WRAP PREPEND "${CMAKE_SOURCE_DIR}/")
