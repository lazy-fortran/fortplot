program main
    ...
    type(figure_t) :: png_fig, pdf_fig, test_fig
    integer :: i
    ...
    ! Show ASCII version - display both sine and cosine properly
    call png_fig%show_ascii(x, sx, size(x), 'sin(x) and cos(x) ASCII plot')
