title: Comprehensive 3D Demo
---

# Comprehensive 3D Demo
...
Source: [example/fortran/3d_plotting/3d_plotting.f90](https://github.com/lazy-fortran/fortplot/blob/main/example/fortran/3d_plotting/3d_plotting.f90)
