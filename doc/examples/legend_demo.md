...
📄 View on GitHub: [legend_demo.f90](https://github.com/krystophny/fortplotlib/blob/main/example/fortran/legend_demo/legend_demo.f90)

🐍 Python equivalent: [legend_demo.py](https://github.com/krystophny/fortplotlib/blob/main/example/python/legend_demo/legend_demo.py)
...
![basic_legend.png](../../media/examples/basic_legend.png)
...
[Download PDF](../../media/examples/basic_legend.pdf)

### Legend Upper Left

![legend_upper_left.png](../../media/examples/legend_upper_left.png)
...
[Download PDF](../../media/examples/legend_upper_left.pdf)

### Legend Upper Right

![legend_upper_right.png](../../media/examples/legend_upper_right.png)
...
[Download PDF](../../media/examples/legend_upper_right.pdf)

### Legend Lower Left

![legend_lower_left.png](../../media/examples/legend_lower_left.png)
...
[Download PDF](../../media/examples/legend_lower_left.pdf)

### Legend Lower Right

![legend_lower_right.png](../../media/examples/legend_lower_right.png)
...
[Download PDF](../../media/examples/legend_lower_right.pdf)

### Multi Function Legend

![multi_function_legend.png](../../media/examples/multi_function_legend.png)
...
[Download PDF](../../media/examples/multi_function_legend.pdf)
