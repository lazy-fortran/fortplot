...
📄 View on GitHub: [colored_contours.f90](https://github.com/krystophny/fortplotlib/blob/main/example/fortran/colored_contours/colored_contours.f90)

🐍 Python equivalent: [colored_contours.py](https://github.com/krystophny/fortplotlib/blob/main/example/python/colored_contours/colored_contours.py)
...
![gaussian_default.png](../../media/examples/gaussian_default.png)
...
[Download PDF](../../media/examples/gaussian_default.pdf)

### Ripple Jet

![ripple_jet.png](../../media/examples/ripple_jet.png)
...
[Download PDF](../../media/examples/ripple_jet.pdf)

### Ripple Coolwarm

![ripple_coolwarm.png](../../media/examples/ripple_coolwarm.png)
...
[Download PDF](../../media/examples/ripple_coolwarm.pdf)

### Ripple Inferno

![ripple_inferno.png](../../media/examples/ripple_inferno.png)
...
[Download PDF](../../media/examples/ripple_inferno.pdf)

### Saddle Plasma

![saddle_plasma.png](../../media/examples/saddle_plasma.png)
...
[Download PDF](../../media/examples/saddle_plasma.pdf)
