...
📄 View on GitHub: [pcolormesh_demo.f90](https://github.com/krystophny/fortplotlib/blob/main/example/fortran/pcolormesh_demo/pcolormesh_demo.f90)

🐍 Python equivalent: [pcolormesh_demo.py](https://github.com/krystophny/fortplotlib/blob/main/example/python/pcolormesh_demo/pcolormesh_demo.py)
...
contains
    ...
    subroutine demo_basic_gradient()
        ...
        call savefig('example/fortran/pcolormesh_demo/pcolormesh_basic.png')
        call savefig('example/fortran/pcolormesh_demo/pcolormesh_basic.pdf')
        call savefig('example/fortran/pcolormesh_demo/pcolormesh_basic.txt')
    ...
    subroutine demo_sinusoidal_pattern()
        ...
        call savefig('example/fortran/pcolormesh_demo/pcolormesh_sinusoidal.png')
        call savefig('example/fortran/pcolormesh_demo/pcolormesh_sinusoidal.pdf')
        call savefig('example/fortran/pcolormesh_demo/pcolormesh_sinusoidal.txt')
    ...
    subroutine demo_different_colormaps()
        ...
        call savefig('example/fortran/pcolormesh_demo/pcolormesh_plasma.png')
        call savefig('example/fortran/pcolormesh_demo/pcolormesh_plasma.pdf')
        call savefig('example/fortran/pcolormesh_demo/pcolormesh_plasma.txt')
...
![pcolormesh_basic.png](../../media/examples/pcolormesh_basic.png)
...
[Download PDF](../../media/examples/pcolormesh_basic.pdf)

### Pcolormesh Plasma

![pcolormesh_plasma.png](../../media/examples/pcolormesh_plasma.png)
...
[Download PDF](../../media/examples/pcolormesh_plasma.pdf)

### Pcolormesh Sinusoidal

![pcolormesh_sinusoidal.png](../../media/examples/pcolormesh_sinusoidal.png)
...
[Download PDF](../../media/examples/pcolormesh_sinusoidal.pdf)
