...
contains
    ...
    subroutine demo_scatter_plot()
        ...
        call fig%legend()
        call fig%savefig('build/example/marker_demo/scatter_plot.png')
        call fig%savefig('build/example/marker_demo/scatter_plot.pdf')
        call fig%savefig('build/example/marker_demo/scatter_plot.txt')
    ...
    subroutine demo_all_marker_types()
        ...
        call fig%legend()
        call fig%savefig('build/example/marker_demo/all_marker_types.png')
        call fig%savefig('build/example/marker_demo/all_marker_types.pdf')
        call fig%savefig('build/example/marker_demo/all_marker_types.txt')
    ...
    subroutine demo_marker_colors()
        ...
        call fig%legend()
        call fig%savefig('build/example/marker_demo/marker_colors.png')
        call fig%savefig('build/example/marker_demo/marker_colors.pdf')
        call fig%savefig('build/example/marker_demo/marker_colors.txt')
