...
contains
    ...
    subroutine log_scale_demo()
        ...
        call savefig('build/example/scale_examples/log_scale.png')
        call savefig('build/example/scale_examples/log_scale.pdf')
        call savefig('build/example/scale_examples/log_scale.txt')
    ...
    subroutine symlog_scale_demo()
        ...
        call xlabel('x') 
        call ylabel('x³ - 50x')
        call savefig('build/example/scale_examples/symlog_scale.png')
        call savefig('build/example/scale_examples/symlog_scale.pdf')
        call savefig('build/example/scale_examples/symlog_scale.txt')
