...
contains
    ...
    subroutine basic_legend_example()
        ...
        call fig%savefig('build/example/legend_demo/basic_legend.png')
        call fig%savefig('build/example/legend_demo/basic_legend.pdf')
        call fig%savefig('build/example/legend_demo/basic_legend.txt')
    ...
    subroutine positioned_legend_example()
        ...
        call fig1%savefig('build/example/legend_demo/legend_upper_left.png')
        call fig1%savefig('build/example/legend_demo/legend_upper_left.pdf')
        call fig1%savefig('build/example/legend_demo/legend_upper_left.txt')
        ...
        call fig2%savefig('build/example/legend_demo/legend_upper_right.png')
        call fig2%savefig('build/example/legend_demo/legend_upper_right.pdf')
        call fig2%savefig('build/example/legend_demo/legend_upper_right.txt')
        ...
        call fig3%savefig('build/example/legend_demo/legend_lower_left.png')
        call fig3%savefig('build/example/legend_demo/legend_lower_left.pdf')
        call fig3%savefig('build/example/legend_demo/legend_lower_left.txt')
        ...
        call fig4%savefig('build/example/legend_demo/legend_lower_right.png')
        call fig4%savefig('build/example/legend_demo/legend_lower_right.pdf')
        call fig4%savefig('build/example/legend_demo/legend_lower_right.txt')
    ...
    subroutine multi_function_legend_example()
        ...
        call fig%savefig('build/example/legend_demo/multi_function_legend.png')
        call fig%savefig('build/example/legend_demo/multi_function_legend.pdf')
        call fig%savefig('build/example/legend_demo/multi_function_legend.txt')
