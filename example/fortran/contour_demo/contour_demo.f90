...
contains
    ...
    subroutine demo_colormap_comparison()
        ...
        call add_contour_filled(x_grid, y_grid, z_grid, cmap='inferno', show_colorbar=.true.)
        ...
        call add_contour_filled(x_grid, y_grid, z_grid, cmap='coolwarm', show_colorbar=.true.)
        ...
        call add_contour_filled(x_grid, y_grid, z_grid, cmap='jet', show_colorbar=.true.)
