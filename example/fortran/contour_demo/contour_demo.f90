...
contains
    ...
    subroutine gaussian_contours()
        ...
        call fig%savefig('build/example/contour_demo/contour_gaussian.png')
        call fig%savefig('build/example/contour_demo/contour_gaussian.pdf')
        call fig%savefig('build/example/contour_demo/contour_gaussian.txt')
    ...
    subroutine mixed_contour_line_plot()
        ...
        call fig%savefig('build/example/contour_demo/mixed_plot.png')
        call fig%savefig('build/example/contour_demo/mixed_plot.pdf')
        call fig%savefig('build/example/contour_demo/mixed_plot.txt')
