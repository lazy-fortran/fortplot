...
contains
    ...
    subroutine simple_plots()
        ...
        call xlabel('x')
        call ylabel('sin(x)')
        call savefig('build/example/basic_plots/simple_plot.png')
        call savefig('build/example/basic_plots/simple_plot.pdf')
        call savefig('build/example/basic_plots/simple_plot.txt')
    ...
    subroutine multi_line_plot()
        ...
        call fig%savefig('build/example/basic_plots/multi_line.png')
        call fig%savefig('build/example/basic_plots/multi_line.pdf')
        call fig%savefig('build/example/basic_plots/multi_line.txt')
