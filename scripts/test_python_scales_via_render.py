#!/usr/bin/env python3
"""Test log-scale rendering via the Python JSON-pipe wrapper."""
import os
import sys
...
def main():
    ...
    out = out_dir / 'python_render_scales_log.png'
    ...
    print(f"OK: scales via JSON pipe -> {out} ({out.stat().st_size} bytes)")
